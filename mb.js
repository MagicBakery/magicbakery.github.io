...
function MacroIcons(el,iHTMLInner){
  ...
  const mIconList = [
    ...
    ["TreasureChestMimic",":TreasureChestMimic:"], 
...
function RND_QuestPersonCondition(mAffinity,mHostility){
  ...
  const WORDS = [
    ...
    ["Formidable", "P", "4"],
    ["Fragile", "C", "4"],
    ["Friendly", "+", "2"],["Frightened", "C", "2"],
    ["Frisky", "M", "2"],
    ["Gassy", "A", "4"],
    ["Gentle", "+", "2"],
    ["Gigantic", "+++", "0"],["Glamorous", "M", "3"],
    ["Gloomy", "O", "4"],
    ["Goofy", "M", "1"],
    ["Group of", "+++", "0"],
    ["Grumpy", "C", "4"],
...
function RND_QuestPerson(mAffinity,mHostility){
  const WORDS = [
    ["Aasimar", "", ""], ["Alligator", "H", "2"],["Angel", "H", "2"], 
    ["Basilisk", "", ""],
    ["Bear", "", ""],["Bison", "+", ""],["Bluejay", "H", ""],["Bumblebee", "", ""],
    ["Butterfly", "", ""],
    ["Cat", "", ""], 
    ["Centaur", "", ""], ["Chimera", "+", ""], ["Coyote", "", ""],
    ["Cyclops", "", ""], ["Deer", "", ""],["Djinn", "", ""], 
    ["Dog", "", ""], ["Dragon", "+++", ""], ["Dryad", "", ""], ["Dwarf", "", ""], 
    ["Eagle", "", ""],["Echidna", "", ""], ["Elemental", "A", ""], ["Elf", "", ""], 
    ["Elk", "", ""],
    ["Fairy", "", ""],["Fox", "", ""], 
...
function Roster(iIndex){
  ...
  const mRoster = ["3B", "44", "Albatross", "Amelia", "Arcacia", "Black", "Cardinal", "Casey", "Chris", "Clyde", "Emi", "Evelyn", "Fina", "Gaia", "Helen", "Ivy", "James", "Jao", "John", "Karl", "Ken", "King", "Kisaragi", "Koyo", "Ledia", "Lei", "Leo", "LRRH", "Mark", "Melody", "Mikela", "Miller", "Natalie", "Neil", "P4", "Patricia", "Rick", "Robert", "Roger", "RS", "Sasha", "Skyle", "StarTree", "Sylvia", "Tanya", "The_Unusual", "Therese", "V", "Vivi", "Vladanya", "Wonder", "Zoey"];
